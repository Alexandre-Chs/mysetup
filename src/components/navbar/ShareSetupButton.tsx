    ...
    <>
      <div className="flex items-center justify-center gap-4">
        <Button
          ...
          {isLoading ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : <div>Share your setup</div>}
          {!isLoading && <MoveRight size={15} className="group-hover:translate-x-1 transition-transform" />}
